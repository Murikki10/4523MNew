...
<body class="pl-dash-body">
  ...
  <nav>
    ...
    <div class="nav-links">
      ...
      <a href="dashboard.php" style="color: #3498db; font-weight: bold;">👤 Hi,
        <?php echo htmlspecialchars($cname); ?></a>
  ...
  <div class="container">
    <div class="dashboard-header">
      ...
      <p style="color: #7f8c8d;">Welcome back, <?php echo htmlspecialchars($cname); ?>. Manage your artisanal orders and
        profile.</p>
    </div>
  ...
  <div class="modal-overlay" id="orderModal">
    <div class="modal-box">
      ...
      <div class="modal-header-receipt" id="modalHeader">
        ...
        <div style="font-size: 11px; text-transform: uppercase; letter-spacing: 3px; opacity: 0.8;">Official Receipt
        </div>
        ...
        <div id="pl-cancelled-notice"
          style="display:none; font-size: 18px; font-weight: 800; letter-spacing: 2px; margin-top: 15px; color: #fff;">
          ❌ CANCELLED
        </div>
      </div>
      ...
      <div class="modal-body">
        ...
        <div class="receipt-section">
          ...
          <div class="info-grid">
            ...
            <div class="info-item" style="grid-column: span 2;"><label>Shipping Address</label><span
                id="mReceiptAddress">Pending Update</span></div>
      ...
      <div class="modal-footer">
        <button type="button" id="pl-footer-close-receipt-btn"
          style="width:100%; background:#2c3e50; color:white; border:none; padding:14px; border-radius:12px; font-weight:600; cursor:pointer;">Close
          Receipt Window</button>
      </div>
    </div>
  </div>
