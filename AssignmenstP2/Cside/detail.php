...
<body class="pl-detail-body">
    ...
    <div id="pl-detail-config-metadata" style="display:none;" data-fid="<?php echo $fid; ?>"
        data-fname="<?php echo htmlspecialchars($fname); ?>" data-price="<?php echo $fprice; ?>"
        data-img="<?php echo $image_path; ?>" data-max-stock="<?php echo $max_stock; ?>">
    </div>
            ...
            <div class="action-card">
                ...
                <?php else: ?>
                    <button type="button" class="btn-cart"
                        style="background:#eee; color:#aaa; cursor:not-allowed; box-shadow:none; transform:none;" disabled>
